...
const CrystalScene: React.FC = () => {
  return (
    <>
      ...
      {/* Lighting: Optimized for Opaque Liu Li - Flatter, softer light */}
      <ambientLight intensity={0.8} color="#ccccff" />
      
      {/* Main Light - Changed to 45 degree angle [10, 10, 10] */}
      <spotLight 
        position={[10, 10, 10]} 
        angle={1.2} 
        penumbra={1} 
      ...
      {/* Rim Light - Cool Blue - Opposite side [-10, 2, -5] */}
      <spotLight 
        position={[-10, 2, -5]} 
        angle={1.2} 
        penumbra={1} 
      ...
      {/* Background Particles - Ethereal dust */}
      ...
      <EffectComposer enableNormalPass={false} multisampling={0}>
        <Bloom 
          ...
          radius={0.4} 
        />
        {/* Significantly reduced vignette for open feel */}
